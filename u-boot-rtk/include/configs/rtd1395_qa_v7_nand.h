...
#ifndef __CONFIG_RTK_RTD1395_QA_NAND_H
#define __CONFIG_RTK_RTD1395_QA_NAND_H
...
#define CONFIG_SYS_RTK_NAND_FLASH
	...
	*   uboot/examples/flash_writer_u/$(CONFIG_FLASH_WRITER_SETTING).inc*/
	#define CONFIG_FLASH_WRITER_SETTING            "1395_force_nand_armv7"
...
#define CONFIG_POWER_DOWN_ETN          1

#endif /* __CONFIG_RTK_RTD1395_QA_NAND_H */
