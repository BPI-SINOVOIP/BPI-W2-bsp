...
#include "../pinctrl/realtek/pinctrl-rtd13xx.h"
#include "gpio-rtd13xx.h"
...
static const struct rtk_gpio_groups rtk_gpio_grps_array[] = {
	{
		...
		.reg_umsk_isr_gpa_off = {0x08, 0xe0, 0x90},
		/* ISO_UMSK_ISR_GPDA0, UMSK_ISR_GPDA1 */
		.reg_umsk_isr_gpda_off = {0x0c, 0xe4, 0x94},
		/* ISO_GPDIR, GPDIR_1 */
		.reg_dir_off = {0x00, 0x18, 0x2C},
		/* ISO_GPDATO, GPDATO_1 */
		.reg_dato_off = {0x04, 0x1c, 0x30},
		/* ISO_GPDATI, GPDATI_1 */
		.reg_dati_off = {0x08, 0x20, 0x34},
		/* ISO_GPIE, GPIE_1 */
		.reg_ie_off = {0x0c, 0x24, 0x38},
		/* ISO_GPDP, GPDP_1 */
		.reg_dp_off = {0x10, 0x28, 0x3C},
		/*ISO_GPDEB*/
		.reg_deb_off = {0x44, 0x48, 0x4C, 0x50, 0x54, 0x58, 0x5C, 0x60, 0x64, 0x68, 0x6C},
	}
};
...
static const struct of_device_id rtk_gpio_of_match[] = {
	{.compatible = "realtek,rtk13xx-iso-gpio-irq-mux",},
	{ /* Sentinel */ },
};
