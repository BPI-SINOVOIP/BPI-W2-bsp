...
enum opt_code
{
  ...
  OPT_mabi_ = 1150,                          /* -mabi= */
  OPT_march_ = 1151,                         /* -march= */
  OPT_mbig_endian = 1152,                    /* -mbig-endian */
  OPT_mbionic = 1153,                        /* -mbionic */
  OPT_mcmodel_ = 1154,                       /* -mcmodel= */
  OPT_mcpu_ = 1155,                          /* -mcpu= */
  OPT_mfix_cortex_a53_835769 = 1156,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 1157,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 1158,             /* -mgeneral-regs-only */
  OPT_mglibc = 1159,                         /* -mglibc */
  OPT_mlittle_endian = 1160,                 /* -mlittle-endian */
  OPT_mlow_precision_div = 1161,             /* -mlow-precision-div */
  OPT_mlow_precision_recip_sqrt = 1162,      /* -mlow-precision-recip-sqrt */
  OPT_mlow_precision_sqrt = 1163,            /* -mlow-precision-sqrt */
  OPT_mmusl = 1164,                          /* -mmusl */
  OPT_momit_leaf_frame_pointer = 1165,       /* -momit-leaf-frame-pointer */
  OPT_moverride_ = 1166,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 1167,     /* -mpc-relative-literal-loads */
  OPT_msign_return_address_ = 1168,          /* -msign-return-address= */
  OPT_mstrict_align = 1169,                  /* -mstrict-align */
  OPT_mtls_dialect_ = 1170,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 1171,                     /* -mtls-size= */
  OPT_mtune_ = 1172,                         /* -mtune= */
  OPT_muclibc = 1173,                        /* -muclibc */
  OPT_mverbose_cost_dump = 1174,             /* -mverbose-cost-dump */
  OPT_n = 1175,                              /* -n */
  OPT_no_canonical_prefixes = 1176,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1177,              /* -no-integrated-cpp */
  OPT_no_pie = 1178,                         /* -no-pie */
  OPT_nocpp = 1179,                          /* -nocpp */
  OPT_nodefaultlibs = 1180,                  /* -nodefaultlibs */
  ...
  OPT_pie = 1191,                            /* -pie */
  OPT_pipe = 1192,                           /* -pipe */
  OPT_posix = 1193,                          /* -posix */
  OPT_print_file_name_ = 1194,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1195,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1196,          /* -print-multi-directory */
  OPT_print_multi_lib = 1197,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1198,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1199,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1200,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1201,               /* -print-prog-name= */
  OPT_print_search_dirs = 1202,              /* -print-search-dirs */
  OPT_print_sysroot = 1203,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1204,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1205,                        /* -profile */
  OPT_pthread = 1206,                        /* -pthread */
  OPT_quiet = 1207,                          /* -quiet */
  OPT_r = 1208,                              /* -r */
  OPT_rdynamic = 1209,                       /* -rdynamic */
  OPT_remap = 1210,                          /* -remap */
  OPT_s = 1211,                              /* -s */
  OPT_save_temps = 1212,                     /* -save-temps */
  OPT_save_temps_ = 1213,                    /* -save-temps= */
  OPT_shared = 1214,                         /* -shared */
  OPT_shared_libgcc = 1215,                  /* -shared-libgcc */
  /* OPT_specs = 1216, */                    /* -specs */
  OPT_specs_ = 1217,                         /* -specs= */
  OPT_static = 1218,                         /* -static */
  OPT_static_libasan = 1219,                 /* -static-libasan */
  OPT_static_libgcc = 1220,                  /* -static-libgcc */
  OPT_static_libgfortran = 1221,             /* -static-libgfortran */
  OPT_static_libgo = 1222,                   /* -static-libgo */
  OPT_static_liblsan = 1223,                 /* -static-liblsan */
  OPT_static_libmpx = 1224,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1225,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1226,               /* -static-libstdc++ */
  OPT_static_libtsan = 1227,                 /* -static-libtsan */
  OPT_static_libubsan = 1228,                /* -static-libubsan */
  /* OPT_std_c__03 = 1229, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1230, */                /* -std=c++0x */
  OPT_std_c__11 = 1231,                      /* -std=c++11 */
  OPT_std_c__14 = 1232,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1233, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1234, */                /* -std=c++1y */
  OPT_std_c__1z = 1235,                      /* -std=c++1z */
  OPT_std_c__98 = 1236,                      /* -std=c++98 */
  OPT_std_c11 = 1237,                        /* -std=c11 */
  /* OPT_std_c1x = 1238, */                  /* -std=c1x */
  /* OPT_std_c89 = 1239, */                  /* -std=c89 */
  OPT_std_c90 = 1240,                        /* -std=c90 */
  OPT_std_c99 = 1241,                        /* -std=c99 */
  /* OPT_std_c9x = 1242, */                  /* -std=c9x */
  OPT_std_f2003 = 1243,                      /* -std=f2003 */
  OPT_std_f2008 = 1244,                      /* -std=f2008 */
  OPT_std_f2008ts = 1245,                    /* -std=f2008ts */
  OPT_std_f95 = 1246,                        /* -std=f95 */
  OPT_std_gnu = 1247,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1248, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1249, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1250,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1251,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1252, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1253, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1254,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1255,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1256,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1257, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1258, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1259,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1260,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1261, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1262, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1263,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1264, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1265, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1266, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1267,                     /* -std=legacy */
  OPT_symbolic = 1268,                       /* -symbolic */
  OPT_t = 1269,                              /* -t */
  OPT_time = 1270,                           /* -time */
  OPT_time_ = 1271,                          /* -time= */
  OPT_traditional = 1272,                    /* -traditional */
  OPT_traditional_cpp = 1273,                /* -traditional-cpp */
  OPT_trigraphs = 1274,                      /* -trigraphs */
  OPT_u = 1275,                              /* -u */
  OPT_undef = 1276,                          /* -undef */
  OPT_v = 1277,                              /* -v */
  OPT_version = 1278,                        /* -version */
  OPT_w = 1279,                              /* -w */
  OPT_wrapper = 1280,                        /* -wrapper */
  OPT_x = 1281,                              /* -x */
  OPT_z = 1282,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
