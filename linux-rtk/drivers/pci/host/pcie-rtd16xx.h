 ...
 */
#ifndef RTK_PCIE_16xx_H_
#define RTK_PCIE_16xx_H_
...
#define PCI_DBG(fmt, args...) \
	pr_info("[RTD16xx PCIE] DBG, " fmt, ## args)
#else
#define PCI_DBG(fmt, args...) \
do { \
} while (0)
...
#define PCI_INFO(fmt, args...) \
	pr_info("[RTD16xx PCIE] INFO," fmt, ## args)
#define PCI_WARNING(fmt, args...) \
	pr_info("[RTD16xx PCIE] WARNING," fmt, ## args)

#ifdef PCI_REG_DBG_EN
#define PCI_REG_DBG(fmt, args...) \
	pr_info("[RTD16xx PCIE] REG DBG," fmt, ## args)
#else
#define PCI_REG_DBG(fmt, args...) \
do { \
} while (0)
...
#define PCI_CFG_DBG(fmt, args...) \
	pr_info("[RTD16xx PCIE] CFG DBG," fmt, ## args)
#else
#define PCI_CFG_DBG(fmt, args...) do {} while (0)
#endif

#define PCI_CFG_WARNING(fmt, args...) pr_alert("[RTD16xx PCIE] CFG WARNING," fmt, ## args)
