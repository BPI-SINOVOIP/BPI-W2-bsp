...
enum opt_code
{
  ...
  OPT_Wboxing = 178,                         /* -Wboxing */
  OPT_Wbuiltin_macro_redefined = 179,        /* -Wbuiltin-macro-redefined */
  OPT_Wc___compat = 180,                     /* -Wc++-compat */
  OPT_Wc__0x_compat = 181,                   /* -Wc++0x-compat */
  /* OPT_Wc__11_compat = 182, */             /* -Wc++11-compat */
  OPT_Wc_binding_type = 183,                 /* -Wc-binding-type */
  OPT_Wcast_align = 184,                     /* -Wcast-align */
  OPT_Wcast_qual = 185,                      /* -Wcast-qual */
  OPT_Wchar_concat = 186,                    /* -Wchar-concat */
  ...
  OPT_Wcondition_assign = 193,               /* -Wcondition-assign */
  OPT_Wconditionally_supported = 194,        /* -Wconditionally-supported */
  ...
  OPT_Wdate_time = 202,                      /* -Wdate-time */
  OPT_Wdeclaration_after_statement = 203,    /* -Wdeclaration-after-statement */
  OPT_Wdelete_incomplete = 204,              /* -Wdelete-incomplete */
  OPT_Wdelete_non_virtual_dtor = 205,        /* -Wdelete-non-virtual-dtor */
  OPT_Wdep_ann = 206,                        /* -Wdep-ann */
  OPT_Wdeprecated = 207,                     /* -Wdeprecated */
  OPT_Wdeprecated_declarations = 208,        /* -Wdeprecated-declarations */
  OPT_Wdisabled_optimization = 209,          /* -Wdisabled-optimization */
  OPT_Wdiscouraged = 210,                    /* -Wdiscouraged */
  OPT_Wdiv_by_zero = 211,                    /* -Wdiv-by-zero */
  OPT_Wdouble_promotion = 212,               /* -Wdouble-promotion */
  OPT_Weffc__ = 213,                         /* -Weffc++ */
  OPT_Wempty_block = 214,                    /* -Wempty-block */
  OPT_Wempty_body = 215,                     /* -Wempty-body */
  OPT_Wendif_labels = 216,                   /* -Wendif-labels */
  OPT_Wenum_compare = 217,                   /* -Wenum-compare */
  OPT_Wenum_identifier = 218,                /* -Wenum-identifier */
  OPT_Wenum_switch = 219,                    /* -Wenum-switch */
  ...
  OPT_Wextraneous_semicolon = 224,           /* -Wextraneous-semicolon */
  OPT_Wfallthrough = 225,                    /* -Wfallthrough */
  OPT_Wfatal_errors = 226,                   /* -Wfatal-errors */
  OPT_Wfield_hiding = 227,                   /* -Wfield-hiding */
  OPT_Wfinal_bound = 228,                    /* -Wfinal-bound */
  OPT_Wfinally = 229,                        /* -Wfinally */
  OPT_Wfloat_conversion = 230,               /* -Wfloat-conversion */
  OPT_Wfloat_equal = 231,                    /* -Wfloat-equal */
  OPT_Wforbidden = 232,                      /* -Wforbidden */
  ...
  OPT_Wmissing_delay_slot = 279,             /* -Wmissing-delay-slot */
  OPT_Wmissing_field_initializers = 280,     /* -Wmissing-field-initializers */
  /* OPT_Wmissing_format_attribute = 281, */ /* -Wmissing-format-attribute */
  OPT_Wmissing_include_dirs = 282,           /* -Wmissing-include-dirs */
  /* OPT_Wmissing_noreturn = 283, */         /* -Wmissing-noreturn */
  OPT_Wmissing_parameter_type = 284,         /* -Wmissing-parameter-type */
  OPT_Wmissing_prototypes = 285,             /* -Wmissing-prototypes */
  /* OPT_Wmudflap = 286, */                  /* -Wmudflap */
  OPT_Wmultichar = 287,                      /* -Wmultichar */
  OPT_Wnarrowing = 288,                      /* -Wnarrowing */
  OPT_Wnested_externs = 289,                 /* -Wnested-externs */
  OPT_Wnls = 290,                            /* -Wnls */
  OPT_Wno_effect_assign = 291,               /* -Wno-effect-assign */
  OPT_Wnoexcept = 292,                       /* -Wnoexcept */
  OPT_Wnon_template_friend = 293,            /* -Wnon-template-friend */
  OPT_Wnon_virtual_dtor = 294,               /* -Wnon-virtual-dtor */
  OPT_Wnonnull = 295,                        /* -Wnonnull */
  OPT_Wnormalized_ = 296,                    /* -Wnormalized= */
  OPT_Wnull = 297,                           /* -Wnull */
  OPT_Wold_style_cast = 298,                 /* -Wold-style-cast */
  OPT_Wold_style_declaration = 299,          /* -Wold-style-declaration */
  OPT_Wold_style_definition = 300,           /* -Wold-style-definition */
  OPT_Wopenmp_simd = 301,                    /* -Wopenmp-simd */
  OPT_Wout_of_date = 302,                    /* -Wout-of-date */
  OPT_Wover_ann = 303,                       /* -Wover-ann */
  OPT_Woverflow = 304,                       /* -Woverflow */
  OPT_Woverlength_strings = 305,             /* -Woverlength-strings */
  OPT_Woverloaded_virtual = 306,             /* -Woverloaded-virtual */
  OPT_Woverride_init = 307,                  /* -Woverride-init */
  OPT_Wp_ = 308,                             /* -Wp, */
  OPT_Wpacked = 309,                         /* -Wpacked */
  OPT_Wpacked_bitfield_compat = 310,         /* -Wpacked-bitfield-compat */
  OPT_Wpadded = 311,                         /* -Wpadded */
  OPT_Wparam_assign = 312,                   /* -Wparam-assign */
  OPT_Wparentheses = 313,                    /* -Wparentheses */
  OPT_Wpedantic = 314,                       /* -Wpedantic */
  OPT_Wpkg_default_method = 315,             /* -Wpkg-default-method */
  OPT_Wpmf_conversions = 316,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 317,                  /* -Wpointer-arith */
  OPT_Wpointer_sign = 318,                   /* -Wpointer-sign */
  OPT_Wpointer_to_int_cast = 319,            /* -Wpointer-to-int-cast */
  OPT_Wpossible_load_use = 320,              /* -Wpossible-load-use */
  OPT_Wpragmas = 321,                        /* -Wpragmas */
  OPT_Wproperty_assign_default = 322,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 323,                       /* -Wprotocol */
  OPT_Wpsabi = 324,                          /* -Wpsabi */
  OPT_Wraw = 325,                            /* -Wraw */
  OPT_Wreal_q_constant = 326,                /* -Wreal-q-constant */
  OPT_Wrealloc_lhs = 327,                    /* -Wrealloc-lhs */
  OPT_Wrealloc_lhs_all = 328,                /* -Wrealloc-lhs-all */
  OPT_Wredundant_decls = 329,                /* -Wredundant-decls */
  OPT_Wredundant_modifiers = 330,            /* -Wredundant-modifiers */
  OPT_Wreorder = 331,                        /* -Wreorder */
  OPT_Wreturn_local_addr = 332,              /* -Wreturn-local-addr */
  OPT_Wreturn_type = 333,                    /* -Wreturn-type */
  OPT_Wselector = 334,                       /* -Wselector */
  OPT_Wsequence_point = 335,                 /* -Wsequence-point */
  OPT_Wserial = 336,                         /* -Wserial */
  OPT_Wshadow = 337,                         /* -Wshadow */
  OPT_Wsign_compare = 338,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 339,                /* -Wsign-conversion */
  OPT_Wsign_promo = 340,                     /* -Wsign-promo */
  OPT_Wsizeof_pointer_memaccess = 341,       /* -Wsizeof-pointer-memaccess */
  OPT_Wspecial_param_hiding = 342,           /* -Wspecial-param-hiding */
  OPT_Wstack_protector = 343,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 344,                   /* -Wstack-usage= */
  OPT_Wstatic_access = 345,                  /* -Wstatic-access */
  OPT_Wstatic_receiver = 346,                /* -Wstatic-receiver */
  OPT_Wstrict_aliasing = 347,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 348,               /* -Wstrict-aliasing= */
  OPT_Wstrict_null_sentinel = 349,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 350,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 351,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 352,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 353,          /* -Wstrict-selector-match */
  OPT_Wsuggest_attribute_const = 354,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_format = 355,       /* -Wsuggest-attribute=format */
  OPT_Wsuggest_attribute_noreturn = 356,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 357,         /* -Wsuggest-attribute=pure */
  OPT_Wsuppress = 358,                       /* -Wsuppress */
  OPT_Wsurprising = 359,                     /* -Wsurprising */
  OPT_Wswitch = 360,                         /* -Wswitch */
  OPT_Wswitch_default = 361,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 362,                    /* -Wswitch-enum */
  OPT_Wsync_nand = 363,                      /* -Wsync-nand */
  OPT_Wsynth = 364,                          /* -Wsynth */
  OPT_Wsynthetic_access = 365,               /* -Wsynthetic-access */
  OPT_Wsystem_headers = 366,                 /* -Wsystem-headers */
  OPT_Wtabs = 367,                           /* -Wtabs */
  OPT_Wtarget_lifetime = 368,                /* -Wtarget-lifetime */
  OPT_Wtasks = 369,                          /* -Wtasks */
  OPT_Wtraditional = 370,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 371,         /* -Wtraditional-conversion */
  OPT_Wtrampolines = 372,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 373,                      /* -Wtrigraphs */
  OPT_Wtype_hiding = 374,                    /* -Wtype-hiding */
  OPT_Wtype_limits = 375,                    /* -Wtype-limits */
  OPT_Wuncheck = 376,                        /* -Wuncheck */
  OPT_Wundeclared_selector = 377,            /* -Wundeclared-selector */
  OPT_Wundef = 378,                          /* -Wundef */
  OPT_Wunderflow = 379,                      /* -Wunderflow */
  OPT_Wuninitialized = 380,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 381,                /* -Wunknown-pragmas */
  OPT_Wunnecessary_else = 382,               /* -Wunnecessary-else */
  OPT_Wunqualified_field = 383,              /* -Wunqualified-field */
  /* OPT_Wunreachable_code = 384, */         /* -Wunreachable-code */
  OPT_Wunsafe_loop_optimizations = 385,      /* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 386,     /* -Wunsuffixed-float-constants */
  OPT_Wunused = 387,                         /* -Wunused */
  OPT_Wunused_argument = 388,                /* -Wunused-argument */
  OPT_Wunused_but_set_parameter = 389,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 390,        /* -Wunused-but-set-variable */
  OPT_Wunused_dummy_argument = 391,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 392,                /* -Wunused-function */
  OPT_Wunused_import = 393,                  /* -Wunused-import */
  OPT_Wunused_label = 394,                   /* -Wunused-label */
  OPT_Wunused_local = 395,                   /* -Wunused-local */
  OPT_Wunused_local_typedefs = 396,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 397,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 398,               /* -Wunused-parameter */
  OPT_Wunused_private = 399,                 /* -Wunused-private */
  OPT_Wunused_result = 400,                  /* -Wunused-result */
  OPT_Wunused_thrown = 401,                  /* -Wunused-thrown */
  OPT_Wunused_value = 402,                   /* -Wunused-value */
  OPT_Wunused_variable = 403,                /* -Wunused-variable */
  OPT_Wuseless_cast = 404,                   /* -Wuseless-cast */
  OPT_Wuseless_type_check = 405,             /* -Wuseless-type-check */
  OPT_Wvarargs = 406,                        /* -Wvarargs */
  OPT_Wvarargs_cast = 407,                   /* -Wvarargs-cast */
  OPT_Wvariadic_macros = 408,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 409,   /* -Wvector-operation-performance */
  OPT_Wvirtual_move_assign = 410,            /* -Wvirtual-move-assign */
  OPT_Wvla = 411,                            /* -Wvla */
  OPT_Wvolatile_register_var = 412,          /* -Wvolatile-register-var */
  OPT_Wwarning_token = 413,                  /* -Wwarning-token */
  OPT_Wwrite_strings = 414,                  /* -Wwrite-strings */
  OPT_Wzero_as_null_pointer_constant = 415,  /* -Wzero-as-null-pointer-constant */
  OPT_Wzerotrip = 416,                       /* -Wzerotrip */
  OPT_Xassembler = 417,                      /* -Xassembler */
  OPT_Xlinker = 418,                         /* -Xlinker */
  OPT_Xpreprocessor = 419,                   /* -Xpreprocessor */
  OPT_Z = 420,                               /* -Z */
  OPT_ansi = 421,                            /* -ansi */
  OPT_aux_info = 422,                        /* -aux-info */
  /* OPT_aux_info_ = 423, */                 /* -aux-info= */
  OPT_auxbase = 424,                         /* -auxbase */
  OPT_auxbase_strip = 425,                   /* -auxbase-strip */
  /* OPT_bootclasspath = 426, */             /* -bootclasspath */
  OPT_c = 427,                               /* -c */
  OPT_cct = 428,                             /* -cct */
  /* OPT_classpath = 429, */                 /* -classpath */
  OPT_coverage = 430,                        /* -coverage */
  OPT_cpp = 431,                             /* -cpp */
  OPT_cpp_ = 432,                            /* -cpp= */
  OPT_d = 433,                               /* -d */
  OPT_dumpbase = 434,                        /* -dumpbase */
  OPT_dumpdir = 435,                         /* -dumpdir */
  OPT_dumpmachine = 436,                     /* -dumpmachine */
  OPT_dumpspecs = 437,                       /* -dumpspecs */
  OPT_dumpversion = 438,                     /* -dumpversion */
  OPT_e = 439,                               /* -e */
  /* OPT_encoding = 440, */                  /* -encoding */
  OPT_export_dynamic = 441,                  /* -export-dynamic */
  OPT_extdirs = 442,                         /* -extdirs */
  /* OPT_fCLASSPATH_ = 443, */               /* -fCLASSPATH= */
  OPT_fPIC = 444,                            /* -fPIC */
  OPT_fPIE = 445,                            /* -fPIE */
  OPT_fRTS_ = 446,                           /* -fRTS= */
  OPT_fabi_version_ = 447,                   /* -fabi-version= */
  OPT_faccess_control = 448,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 449,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 450,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 451,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 452,                  /* -falign-commons */
  OPT_falign_functions = 453,                /* -falign-functions */
  OPT_falign_functions_ = 454,               /* -falign-functions= */
  OPT_falign_jumps = 455,                    /* -falign-jumps */
  OPT_falign_jumps_ = 456,                   /* -falign-jumps= */
  OPT_falign_labels = 457,                   /* -falign-labels */
  OPT_falign_labels_ = 458,                  /* -falign-labels= */
  OPT_falign_loops = 459,                    /* -falign-loops */
  OPT_falign_loops_ = 460,                   /* -falign-loops= */
  OPT_fall_intrinsics = 461,                 /* -fall-intrinsics */
  /* OPT_fall_virtual = 462, */              /* -fall-virtual */
  OPT_fallow_leading_underscore = 463,       /* -fallow-leading-underscore */
  OPT_fallow_parameterless_variadic_functions = 464,/* -fallow-parameterless-variadic-functions */
  /* OPT_falt_external_templates = 465, */   /* -falt-external-templates */
  /* OPT_fargument_alias = 466, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 467, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 468, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 469, */  /* -fargument-noalias-global */
  OPT_fasm = 470,                            /* -fasm */
  OPT_fassert = 471,                         /* -fassert */
  OPT_fassociative_math = 472,               /* -fassociative-math */
  OPT_fassume_compiled = 473,                /* -fassume-compiled */
  OPT_fassume_compiled_ = 474,               /* -fassume-compiled= */
  OPT_fasynchronous_unwind_tables = 475,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 476,                   /* -fauto-inc-dec */
  OPT_fautomatic = 477,                      /* -fautomatic */
  OPT_faux_classpath = 478,                  /* -faux-classpath */
  OPT_fbackslash = 479,                      /* -fbackslash */
  OPT_fbacktrace = 480,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 481,             /* -fblas-matmul-limit= */
  OPT_fbootclasspath_ = 482,                 /* -fbootclasspath= */
  OPT_fbootstrap_classes = 483,              /* -fbootstrap-classes */
  OPT_fbounds_check = 484,                   /* -fbounds-check */
  OPT_fbranch_count_reg = 485,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 486,           /* -fbranch-probabilities */
  OPT_fbranch_target_load_optimize = 487,    /* -fbranch-target-load-optimize */
  OPT_fbranch_target_load_optimize2 = 488,   /* -fbranch-target-load-optimize2 */
  OPT_fbtr_bb_exclusive = 489,               /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 490,                /* -fbuilding-libgcc */
  OPT_fbuiltin = 491,                        /* -fbuiltin */
  OPT_fbuiltin_ = 492,                       /* -fbuiltin- */
  OPT_fcall_saved_ = 493,                    /* -fcall-saved- */
  OPT_fcall_used_ = 494,                     /* -fcall-used- */
  OPT_fcaller_saves = 495,                   /* -fcaller-saves */
  OPT_fcanonical_system_headers = 496,       /* -fcanonical-system-headers */
  ...
  OPT_fcilkplus = 502,                       /* -fcilkplus */
  OPT_fclasspath_ = 503,                     /* -fclasspath= */
  OPT_fcoarray_ = 504,                       /* -fcoarray= */
  OPT_fcombine_stack_adjustments = 505,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 506,                         /* -fcommon */
  OPT_fcompare_debug = 507,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 508,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 509,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 510,                   /* -fcompare-elim */
  OPT_fcompile_resource_ = 511,              /* -fcompile-resource= */
  OPT_fcond_mismatch = 512,                  /* -fcond-mismatch */
  OPT_fconserve_space = 513,                 /* -fconserve-space */
  OPT_fconserve_stack = 514,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 515,         /* -fconstant-string-class= */
  OPT_fconstexpr_depth_ = 516,               /* -fconstexpr-depth= */
  OPT_fconvert_big_endian = 517,             /* -fconvert=big-endian */
  OPT_fconvert_little_endian = 518,          /* -fconvert=little-endian */
  OPT_fconvert_native = 519,                 /* -fconvert=native */
  OPT_fconvert_swap = 520,                   /* -fconvert=swap */
  OPT_fcprop_registers = 521,                /* -fcprop-registers */
  OPT_fcray_pointer = 522,                   /* -fcray-pointer */
  OPT_fcrossjumping = 523,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 524,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 525, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 526,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 527,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 528,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 529,            /* -fd-lines-as-comments */
  OPT_fdafile_relative = 530,                /* -fdafile-relative */
  OPT_fdata_sections = 531,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 532,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 533,                       /* -fdbg-cnt= */
  OPT_fdce = 534,                            /* -fdce */
  OPT_fdebug_cpp = 535,                      /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 536,              /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 537,            /* -fdebug-types-section */
  OPT_fdeclone_ctor_dtor = 538,              /* -fdeclone-ctor-dtor */
  OPT_fdeduce_init_list = 539,               /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 540,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 541, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 542,              /* -fdefault-integer-8 */
  OPT_fdefault_real_8 = 543,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 544,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 545,                 /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 546,         /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 547,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 548,                   /* -fdevirtualize */
  OPT_fdevirtualize_speculatively = 549,     /* -fdevirtualize-speculatively */
  /* OPT_fdiagnostics_color = 550, */        /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 551,             /* -fdiagnostics-color= */
  OPT_fdiagnostics_show_caret = 552,         /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_location_ = 553,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 554,        /* -fdiagnostics-show-option */
  OPT_fdirectives_only = 555,                /* -fdirectives-only */
  OPT_fdisable_ = 556,                       /* -fdisable- */
  OPT_fdisable_assertions = 557,             /* -fdisable-assertions */
  OPT_fdisable_assertions_ = 558,            /* -fdisable-assertions= */
  OPT_fdollar_ok = 559,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 560,         /* -fdollars-in-identifiers */
  OPT_fdse = 561,                            /* -fdse */
  OPT_fdump_ = 562,                          /* -fdump- */
  OPT_fdump_ada_spec = 563,                  /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 564,             /* -fdump-ada-spec-slim */
  /* OPT_fdump_core = 565, */                /* -fdump-core */
  OPT_fdump_final_insns = 566,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 567,              /* -fdump-final-insns= */
  OPT_fdump_fortran_optimized = 568,         /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 569,          /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 570,                  /* -fdump-go-spec= */
  OPT_fdump_noaddr = 571,                    /* -fdump-noaddr */
  OPT_fdump_parse_tree = 572,                /* -fdump-parse-tree */
  OPT_fdump_passes = 573,                    /* -fdump-passes */
  OPT_fdump_unnumbered = 574,                /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 575,          /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 576,                 /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 577,                 /* -fearly-inlining */
  OPT_felide_constructors = 578,             /* -felide-constructors */
  OPT_feliminate_dwarf2_dups = 579,          /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 580, /* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 581,   /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 582,        /* -femit-class-debug-always */
  OPT_femit_class_file = 583,                /* -femit-class-file */
  OPT_femit_class_files = 584,               /* -femit-class-files */
  OPT_femit_struct_debug_baseonly = 585,     /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 586,    /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 587,      /* -femit-struct-debug-reduced */
  OPT_fenable_ = 588,                        /* -fenable- */
  OPT_fenable_assertions = 589,              /* -fenable-assertions */
  OPT_fenable_assertions_ = 590,             /* -fenable-assertions= */
  OPT_fencoding_ = 591,                      /* -fencoding= */
  OPT_fenforce_eh_specs = 592,               /* -fenforce-eh-specs */
  /* OPT_fenum_int_equiv = 593, */           /* -fenum-int-equiv */
  OPT_fexceptions = 594,                     /* -fexceptions */
  OPT_fexcess_precision_ = 595,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 596,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 597,        /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 598,           /* -fext-numeric-literals */
  OPT_fextdirs_ = 599,                       /* -fextdirs= */
  OPT_fextended_identifiers = 600,           /* -fextended-identifiers */
  OPT_fextern_tls_init = 601,                /* -fextern-tls-init */
  OPT_fexternal_blas = 602,                  /* -fexternal-blas */
  /* OPT_fexternal_templates = 603, */       /* -fexternal-templates */
  OPT_ff2c = 604,                            /* -ff2c */
  OPT_ffast_math = 605,                      /* -ffast-math */
  OPT_ffat_lto_objects = 606,                /* -ffat-lto-objects */
  OPT_fffp = 607,                            /* -fffp */
  OPT_ffilelist_file = 608,                  /* -ffilelist-file */
  OPT_ffinite_math_only = 609,               /* -ffinite-math-only */
  OPT_ffix_bdsl = 610,                       /* -ffix-bdsl */
  OPT_ffixed_ = 611,                         /* -ffixed- */
  OPT_ffixed_form = 612,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 613,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 614,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 615,                    /* -ffloat-store */
  OPT_ffor_scope = 616,                      /* -ffor-scope */
  /* OPT_fforce_addr = 617, */               /* -fforce-addr */
  OPT_fforce_classes_archive_check = 618,    /* -fforce-classes-archive-check */
  OPT_fforward_propagate = 619,              /* -fforward-propagate */
  OPT_ffp_contract_ = 620,                   /* -ffp-contract= */
  OPT_ffpe_summary_ = 621,                   /* -ffpe-summary= */
  OPT_ffpe_trap_ = 622,                      /* -ffpe-trap= */
  OPT_ffree_form = 623,                      /* -ffree-form */
  OPT_ffree_line_length_ = 624,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 625,          /* -ffree-line-length-none */
  OPT_ffreestanding = 626,                   /* -ffreestanding */
  OPT_ffriend_injection = 627,               /* -ffriend-injection */
  OPT_ffrontend_optimize = 628,              /* -ffrontend-optimize */
  OPT_ffunction_cse = 629,                   /* -ffunction-cse */
  OPT_ffunction_sections = 630,              /* -ffunction-sections */
  OPT_fgcse = 631,                           /* -fgcse */
  OPT_fgcse_after_reload = 632,              /* -fgcse-after-reload */
  OPT_fgcse_las = 633,                       /* -fgcse-las */
  OPT_fgcse_lm = 634,                        /* -fgcse-lm */
  OPT_fgcse_sm = 635,                        /* -fgcse-sm */
  OPT_fgnu_keywords = 636,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 637,                    /* -fgnu-runtime */
  OPT_fgnu_tm = 638,                         /* -fgnu-tm */
  OPT_fgnu_unique = 639,                     /* -fgnu-unique */
  OPT_fgnu89_inline = 640,                   /* -fgnu89-inline */
  OPT_fgo_check_divide_overflow = 641,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 642,           /* -fgo-check-divide-zero */
  OPT_fgo_dump_ = 643,                       /* -fgo-dump- */
  OPT_fgo_optimize_ = 644,                   /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 645,                    /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 646,                     /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 647,       /* -fgo-relative-import-path= */
  OPT_fgraphite = 648,                       /* -fgraphite */
  OPT_fgraphite_identity = 649,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 650,       /* -fguess-branch-probability */
  /* OPT_fguiding_decls = 651, */            /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 652, */        /* -fhandle-exceptions */
  OPT_fhash_synchronization = 653,           /* -fhash-synchronization */
  /* OPT_fhelp = 654, */                     /* -fhelp */
  /* OPT_fhelp_ = 655, */                    /* -fhelp= */
  OPT_fhoist_adjacent_loads = 656,           /* -fhoist-adjacent-loads */
  /* OPT_fhonor_std = 657, */                /* -fhonor-std */
  OPT_fhosted = 658,                         /* -fhosted */
  /* OPT_fhuge_objects = 659, */             /* -fhuge-objects */
  OPT_fident = 660,                          /* -fident */
  OPT_fif_conversion = 661,                  /* -fif-conversion */
  OPT_fif_conversion2 = 662,                 /* -fif-conversion2 */
  OPT_fimplement_inlines = 663,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 664,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 665,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 666,             /* -fimplicit-templates */
  OPT_findirect_classes = 667,               /* -findirect-classes */
  OPT_findirect_dispatch = 668,              /* -findirect-dispatch */
  OPT_findirect_inlining = 669,              /* -findirect-inlining */
  OPT_finhibit_size_directive = 670,         /* -finhibit-size-directive */
  OPT_finit_character_ = 671,                /* -finit-character= */
  OPT_finit_integer_ = 672,                  /* -finit-integer= */
  OPT_finit_local_zero = 673,                /* -finit-local-zero */
  OPT_finit_logical_ = 674,                  /* -finit-logical= */
  OPT_finit_real_ = 675,                     /* -finit-real= */
  OPT_finline = 676,                         /* -finline */
  OPT_finline_atomics = 677,                 /* -finline-atomics */
  OPT_finline_functions = 678,               /* -finline-functions */
  OPT_finline_functions_called_once = 679,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 680, */            /* -finline-limit- */
  OPT_finline_limit_ = 681,                  /* -finline-limit= */
  OPT_finline_small_functions = 682,         /* -finline-small-functions */
  OPT_finput_charset_ = 683,                 /* -finput-charset= */
  OPT_finstrument_functions = 684,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 685,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 686,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 687,            /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 688,         /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 689,        /* -fintrinsic-modules-path= */
  OPT_fipa_cp = 690,                         /* -fipa-cp */
  OPT_fipa_cp_clone = 691,                   /* -fipa-cp-clone */
  /* OPT_fipa_matrix_reorg = 692, */         /* -fipa-matrix-reorg */
  OPT_fipa_profile = 693,                    /* -fipa-profile */
  OPT_fipa_pta = 694,                        /* -fipa-pta */
  OPT_fipa_pure_const = 695,                 /* -fipa-pure-const */
  OPT_fipa_reference = 696,                  /* -fipa-reference */
  OPT_fipa_sra = 697,                        /* -fipa-sra */
  /* OPT_fipa_struct_reorg = 698, */         /* -fipa-struct-reorg */
  OPT_fira_algorithm_ = 699,                 /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 700,             /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 701,              /* -fira-loop-pressure */
  OPT_fira_region_ = 702,                    /* -fira-region= */
  OPT_fira_share_save_slots = 703,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 704,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 705,                   /* -fira-verbose= */
  OPT_fisolate_erroneous_paths_attribute = 706,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 707,/* -fisolate-erroneous-paths-dereference */
  OPT_fivopts = 708,                         /* -fivopts */
  OPT_fjni = 709,                            /* -fjni */
  OPT_fjump_tables = 710,                    /* -fjump-tables */
  OPT_fkeep_inline_dllexport = 711,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 712,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 713,             /* -fkeep-static-consts */
  /* OPT_flabels_ok = 714, */                /* -flabels-ok */
  OPT_flax_vector_conversions = 715,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 716,             /* -fleading-underscore */
  OPT_flifetime_dse = 717,                   /* -flifetime-dse */
  OPT_flive_range_shrinkage = 718,           /* -flive-range-shrinkage */
  OPT_floop_block = 719,                     /* -floop-block */
  /* OPT_floop_flatten = 720, */             /* -floop-flatten */
  OPT_floop_interchange = 721,               /* -floop-interchange */
  OPT_floop_nest_optimize = 722,             /* -floop-nest-optimize */
  /* OPT_floop_optimize = 723, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 724,           /* -floop-parallelize-all */
  OPT_floop_strip_mine = 725,                /* -floop-strip-mine */
  OPT_flto = 726,                            /* -flto */
  OPT_flto_compression_level_ = 727,         /* -flto-compression-level= */
  OPT_flto_partition_1to1 = 728,             /* -flto-partition=1to1 */
  OPT_flto_partition_balanced = 729,         /* -flto-partition=balanced */
  OPT_flto_partition_max = 730,              /* -flto-partition=max */
  OPT_flto_partition_none = 731,             /* -flto-partition=none */
  OPT_flto_report = 732,                     /* -flto-report */
  OPT_flto_report_wpa = 733,                 /* -flto-report-wpa */
  OPT_flto_ = 734,                           /* -flto= */
  OPT_fltrans = 735,                         /* -fltrans */
  OPT_fltrans_output_list_ = 736,            /* -fltrans-output-list= */
  OPT_fmain_ = 737,                          /* -fmain= */
  OPT_fmath_errno = 738,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 739,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 740,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 741,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 742,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 743,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 744,                     /* -fmem-report */
  OPT_fmem_report_wpa = 745,                 /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 746,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 747,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 748,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 749,                /* -fmessage-length= */
  OPT_fmodule_private = 750,                 /* -fmodule-private */
  OPT_fmodulo_sched = 751,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 752,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 753,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 754,                  /* -fms-extensions */
  /* OPT_fmudflap = 755, */                  /* -fmudflap */
  /* OPT_fmudflapir = 756, */                /* -fmudflapir */
  /* OPT_fmudflapth = 757, */                /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 758, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 759, */                  /* -fnew-abi */
  OPT_fnext_runtime = 760,                   /* -fnext-runtime */
  OPT_fnil_receivers = 761,                  /* -fnil-receivers */
  /* OPT_fno_vect_cost_model = 762, */       /* -fno-vect-cost-model */
  OPT_fnon_call_exceptions = 763,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 764,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 765, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 766,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 767,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 768,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 769,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 770,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 771,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 772,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 773,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 774,                 /* -fobjc-std=objc1 */
  OPT_fomit_frame_pointer = 775,             /* -fomit-frame-pointer */
  OPT_fopenmp = 776,                         /* -fopenmp */
  OPT_fopenmp_simd = 777,                    /* -fopenmp-simd */
  OPT_foperator_names = 778,                 /* -foperator-names */
  OPT_fopt_info = 779,                       /* -fopt-info */
  OPT_fopt_info_ = 780,                      /* -fopt-info- */
  /* OPT_foptimize_register_move = 781, */   /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 782,         /* -foptimize-sibling-calls */
  OPT_foptimize_static_class_initialization = 783,/* -foptimize-static-class-initialization */
  OPT_foptimize_strlen = 784,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 785, */           /* -foptional-diags */
  OPT_foutput_class_dir_ = 786,              /* -foutput-class-dir= */
  OPT_fpack_derived = 787,                   /* -fpack-derived */
  OPT_fpack_struct = 788,                    /* -fpack-struct */
  OPT_fpack_struct_ = 789,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 790,               /* -fpartial-inlining */
  OPT_fpcc_struct_return = 791,              /* -fpcc-struct-return */
  OPT_fpch_deps = 792,                       /* -fpch-deps */
  OPT_fpch_preprocess = 793,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 794,                     /* -fpeel-loops */
  OPT_fpeephole = 795,                       /* -fpeephole */
  OPT_fpeephole2 = 796,                      /* -fpeephole2 */
  OPT_fpermissive = 797,                     /* -fpermissive */
  OPT_fpic = 798,                            /* -fpic */
  OPT_fpie = 799,                            /* -fpie */
  OPT_fplan9_extensions = 800,               /* -fplan9-extensions */
  OPT_fplugin_arg_ = 801,                    /* -fplugin-arg- */
  OPT_fplugin_ = 802,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 803,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 804,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 805,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 806,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 807,                   /* -fpreprocessed */
  OPT_fpretty_templates = 808,               /* -fpretty-templates */
  OPT_fprofile = 809,                        /* -fprofile */
  OPT_fprofile_arcs = 810,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 811,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 812,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 813,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 814,              /* -fprofile-generate= */
  OPT_fprofile_reorder_functions = 815,      /* -fprofile-reorder-functions */
  OPT_fprofile_report = 816,                 /* -fprofile-report */
  OPT_fprofile_use = 817,                    /* -fprofile-use */
  OPT_fprofile_use_ = 818,                   /* -fprofile-use= */
  OPT_fprofile_values = 819,                 /* -fprofile-values */
  OPT_fprotect_parens = 820,                 /* -fprotect-parens */
  OPT_frandom_seed = 821,                    /* -frandom-seed */
  OPT_frandom_seed_ = 822,                   /* -frandom-seed= */
  OPT_frange_check = 823,                    /* -frange-check */
  OPT_freal_4_real_10 = 824,                 /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 825,                 /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 826,                  /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 827,                 /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 828,                 /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 829,                  /* -freal-8-real-4 */
  OPT_frealloc_lhs = 830,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 831,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 832,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 833,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 834,                /* -frecord-marker=8 */
  OPT_frecursive = 835,                      /* -frecursive */
  OPT_freduced_reflection = 836,             /* -freduced-reflection */
  OPT_free = 837,                            /* -free */
  OPT_freg_struct_return = 838,              /* -freg-struct-return */
  /* OPT_fregmove = 839, */                  /* -fregmove */
  OPT_frename_registers = 840,               /* -frename-registers */
  OPT_freorder_blocks = 841,                 /* -freorder-blocks */
  OPT_freorder_blocks_and_partition = 842,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 843,              /* -freorder-functions */
  OPT_frepack_arrays = 844,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 845,           /* -freplace-objc-classes */
  OPT_frepo = 846,                           /* -frepo */
  OPT_frequire_return_statement = 847,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 848,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 849, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 850,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 851,                    /* -fresolution= */
  OPT_frlxcov = 852,                         /* -frlxcov */
  OPT_frounding_math = 853,                  /* -frounding-math */
  OPT_frtti = 854,                           /* -frtti */
  OPT_fsanitize_ = 855,                      /* -fsanitize= */
  OPT_fsaw_java_file = 856,                  /* -fsaw-java-file */
  OPT_fsched_critical_path_heuristic = 857,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 858,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 859,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 860,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 861,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 862,                 /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 863,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 864,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 865,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 866,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 867,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 868,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 869,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 870,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 871,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 872,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 873,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 874, */        /* -fsched2-use-traces */
  OPT_fschedule_insns = 875,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 876,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 877,              /* -fsecond-underscore */
  OPT_fsection_anchors = 878,                /* -fsection-anchors */
  /* OPT_fsee = 879, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 880,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 881,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 882, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 883,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 884,          /* -fselective-scheduling2 */
  OPT_fshort_double = 885,                   /* -fshort-double */
  OPT_fshort_enums = 886,                    /* -fshort-enums */
  OPT_fshort_wchar = 887,                    /* -fshort-wchar */
  OPT_fshow_column = 888,                    /* -fshow-column */
  OPT_fshrink_wrap = 889,                    /* -fshrink-wrap */
  OPT_fsign_zero = 890,                      /* -fsign-zero */
  OPT_fsignaling_nans = 891,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 892,               /* -fsigned-bitfields */
  OPT_fsigned_char = 893,                    /* -fsigned-char */
  OPT_fsigned_zeros = 894,                   /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 895,               /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 896,      /* -fsingle-precision-constant */
  OPT_fsource_filename_ = 897,               /* -fsource-filename= */
  OPT_fsource_ = 898,                        /* -fsource= */
  OPT_fsplit_ivs_in_unroller = 899,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_stack = 900,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 901,               /* -fsplit-wide-types */
  /* OPT_fsquangle = 902, */                 /* -fsquangle */
  OPT_fstack_arrays = 903,                   /* -fstack-arrays */
  /* OPT_fstack_check = 904, */              /* -fstack-check */
  OPT_fstack_check_ = 905,                   /* -fstack-check= */
  OPT_fstack_limit = 906,                    /* -fstack-limit */
  OPT_fstack_limit_register_ = 907,          /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 908,            /* -fstack-limit-symbol= */
  OPT_fstack_protector = 909,                /* -fstack-protector */
  OPT_fstack_protector_all = 910,            /* -fstack-protector-all */
  OPT_fstack_protector_strong = 911,         /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 912,                   /* -fstack-reuse= */
  OPT_fstack_usage = 913,                    /* -fstack-usage */
  OPT_fstats = 914,                          /* -fstats */
  OPT_fstore_check = 915,                    /* -fstore-check */
  /* OPT_fstrength_reduce = 916, */          /* -fstrength-reduce */
  OPT_fstrict_aliasing = 917,                /* -fstrict-aliasing */
  OPT_fstrict_enums = 918,                   /* -fstrict-enums */
  OPT_fstrict_overflow = 919,                /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 920, */         /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 921,      /* -fstrict-volatile-bitfields */
  OPT_fsuppress_outer_loop_unroll = 922,     /* -fsuppress-outer-loop-unroll */
  OPT_fsync_libcalls = 923,                  /* -fsync-libcalls */
  OPT_fsyntax_only = 924,                    /* -fsyntax-only */
  OPT_ftabstop_ = 925,                       /* -ftabstop= */
  /* OPT_ftarget_help = 926, */              /* -ftarget-help */
  OPT_ftarget_ = 927,                        /* -ftarget= */
  OPT_ftemplate_backtrace_limit_ = 928,      /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 929, */          /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 930,                /* -ftemplate-depth= */
  OPT_ftest_coverage = 931,                  /* -ftest-coverage */
  /* OPT_fthis_is_variable = 932, */         /* -fthis-is-variable */
  OPT_fthread_jumps = 933,                   /* -fthread-jumps */
  OPT_fthreadsafe_statics = 934,             /* -fthreadsafe-statics */
  OPT_ftime_report = 935,                    /* -ftime-report */
  OPT_ftls_model_ = 936,                     /* -ftls-model= */
  OPT_ftoplevel_reorder = 937,               /* -ftoplevel-reorder */
  OPT_ftracer = 938,                         /* -ftracer */
  OPT_ftrack_macro_expansion = 939,          /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 940,         /* -ftrack-macro-expansion= */
  OPT_ftrapping_math = 941,                  /* -ftrapping-math */
  OPT_ftrapv = 942,                          /* -ftrapv */
  OPT_ftree_bit_ccp = 943,                   /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 944,          /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 945,                       /* -ftree-ccp */
  OPT_ftree_ch = 946,                        /* -ftree-ch */
  OPT_ftree_coalesce_inlined_vars = 947,     /* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 948,             /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 949,                 /* -ftree-copy-prop */
  OPT_ftree_copyrename = 950,                /* -ftree-copyrename */
  OPT_ftree_cselim = 951,                    /* -ftree-cselim */
  OPT_ftree_dce = 952,                       /* -ftree-dce */
  OPT_ftree_dominator_opts = 953,            /* -ftree-dominator-opts */
  OPT_ftree_dse = 954,                       /* -ftree-dse */
  OPT_ftree_forwprop = 955,                  /* -ftree-forwprop */
  OPT_ftree_fre = 956,                       /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 957,  /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 958,         /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 959,           /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 960,    /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 961,                   /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 962,              /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 963, */         /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 964,             /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 965,            /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 966,                       /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 967,        /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 968,               /* -ftree-partial-pre */
  OPT_ftree_phiprop = 969,                   /* -ftree-phiprop */
  OPT_ftree_pre = 970,                       /* -ftree-pre */
  OPT_ftree_pta = 971,                       /* -ftree-pta */
  OPT_ftree_reassoc = 972,                   /* -ftree-reassoc */
  /* OPT_ftree_salias = 973, */              /* -ftree-salias */
  OPT_ftree_scev_cprop = 974,                /* -ftree-scev-cprop */
  OPT_ftree_sink = 975,                      /* -ftree-sink */
  OPT_ftree_slp_vectorize = 976,             /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 977,                      /* -ftree-slsr */
  OPT_ftree_sra = 978,                       /* -ftree-sra */
  /* OPT_ftree_store_ccp = 979, */           /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 980, */     /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 981,         /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 982,                /* -ftree-tail-merge */
  OPT_ftree_ter = 983,                       /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 984, */   /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 985,                 /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 986, */ /* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 987,                       /* -ftree-vrp */
  OPT_ftword = 988,                          /* -ftword */
  OPT_ftword_stack = 989,                    /* -ftword-stack */
  OPT_funderscoring = 990,                   /* -funderscoring */
  OPT_funit_at_a_time = 991,                 /* -funit-at-a-time */
  OPT_funroll_all_loops = 992,               /* -funroll-all-loops */
  OPT_funroll_loops = 993,                   /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 994,      /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 995,      /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 996,             /* -funsigned-bitfields */
  OPT_funsigned_char = 997,                  /* -funsigned-char */
  OPT_funswitch_loops = 998,                 /* -funswitch-loops */
  OPT_funwind_tables = 999,                  /* -funwind-tables */
  OPT_fuse_atomic_builtins = 1000,           /* -fuse-atomic-builtins */
  OPT_fuse_balx = 1001,                      /* -fuse-balx */
  OPT_fuse_boehm_gc = 1002,                  /* -fuse-boehm-gc */
  OPT_fuse_cxa_atexit = 1003,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1004,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 1005,         /* -fuse-divide-subroutine */
  OPT_fuse_ld_bfd = 1006,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1007,                   /* -fuse-ld=gold */
  OPT_fuse_linker_plugin = 1008,             /* -fuse-linker-plugin */
  OPT_fuse_tls = 1009,                       /* -fuse-tls */
  OPT_fuse_uls = 1010,                       /* -fuse-uls */
  OPT_fvar_tracking = 1011,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1012,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1013,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1014,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1015,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1016, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1017,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1018,                   /* -fverbose-asm */
  /* OPT_fversion = 1019, */                 /* -fversion */
  OPT_fvisibility_inlines_hidden = 1020,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1021,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1022,                   /* -fvisibility= */
  OPT_fvpt = 1023,                           /* -fvpt */
  /* OPT_fvtable_gc = 1024, */               /* -fvtable-gc */
  /* OPT_fvtable_thunks = 1025, */           /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1026,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1027,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1028,                     /* -fvtv-debug */
  OPT_fweak = 1029,                          /* -fweak */
  OPT_fweb = 1030,                           /* -fweb */
  /* OPT_fwhole_file = 1031, */              /* -fwhole-file */
  OPT_fwhole_program = 1032,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1033,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1034,             /* -fworking-directory */
  OPT_fwpa = 1035,                           /* -fwpa */
  OPT_fwpa_ = 1036,                          /* -fwpa= */
  OPT_fwrapv = 1037,                         /* -fwrapv */
  /* OPT_fxref = 1038, */                    /* -fxref */
  /* OPT_fzee = 1039, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1040,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1041,                     /* -fzero-link */
  OPT_g = 1042,                              /* -g */
  OPT_gant = 1043,                           /* -gant */
  OPT_gcoff = 1044,                          /* -gcoff */
  OPT_gdwarf = 1045,                         /* -gdwarf */
  OPT_gdwarf_ = 1046,                        /* -gdwarf- */
  OPT_gen_decls = 1047,                      /* -gen-decls */
  OPT_ggdb = 1048,                           /* -ggdb */
  OPT_ggnu_pubnames = 1049,                  /* -ggnu-pubnames */
  OPT_gnat = 1050,                           /* -gnat */
  OPT_gnatO = 1051,                          /* -gnatO */
  OPT_gno_pubnames = 1052,                   /* -gno-pubnames */
  OPT_gno_record_gcc_switches = 1053,        /* -gno-record-gcc-switches */
  OPT_gno_split_dwarf = 1054,                /* -gno-split-dwarf */
  OPT_gno_strict_dwarf = 1055,               /* -gno-strict-dwarf */
  OPT_gpubnames = 1056,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1057,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1058,                   /* -gsplit-dwarf */
  OPT_gstabs = 1059,                         /* -gstabs */
  OPT_gstabs_ = 1060,                        /* -gstabs+ */
  OPT_gstrict_dwarf = 1061,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1062,                        /* -gtoggle */
  OPT_gvms = 1063,                           /* -gvms */
  OPT_gxcoff = 1064,                         /* -gxcoff */
  OPT_gxcoff_ = 1065,                        /* -gxcoff+ */
  OPT_h = 1066,                              /* -h */
  OPT_idirafter = 1067,                      /* -idirafter */
  OPT_imacros = 1068,                        /* -imacros */
  OPT_imultiarch = 1069,                     /* -imultiarch */
  OPT_imultilib = 1070,                      /* -imultilib */
  OPT_include = 1071,                        /* -include */
  OPT_iplugindir_ = 1072,                    /* -iplugindir= */
  OPT_iprefix = 1073,                        /* -iprefix */
  OPT_iquote = 1074,                         /* -iquote */
  OPT_isysroot = 1075,                       /* -isysroot */
  OPT_isystem = 1076,                        /* -isystem */
  OPT_iwithprefix = 1077,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1078,              /* -iwithprefixbefore */
  OPT_k8 = 1079,                             /* -k8 */
  OPT_l = 1080,                              /* -l */
  OPT_lang_asm = 1081,                       /* -lang-asm */
  OPT_mabi_ = 1082,                          /* -mabi= */
  OPT_march_ = 1083,                         /* -march= */
  OPT_mbig_endian = 1084,                    /* -mbig-endian */
  OPT_mbionic = 1085,                        /* -mbionic */
  OPT_mcmodel_ = 1086,                       /* -mcmodel= */
  OPT_mcpu_ = 1087,                          /* -mcpu= */
  OPT_mfix_cortex_a53_835769 = 1088,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 1089,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 1090,             /* -mgeneral-regs-only */
  OPT_mglibc = 1091,                         /* -mglibc */
  OPT_mlittle_endian = 1092,                 /* -mlittle-endian */
  OPT_mlra = 1093,                           /* -mlra */
  OPT_mmusl = 1094,                          /* -mmusl */
  OPT_momit_leaf_frame_pointer = 1095,       /* -momit-leaf-frame-pointer */
  OPT_mstrict_align = 1096,                  /* -mstrict-align */
  OPT_mtls_dialect_ = 1097,                  /* -mtls-dialect= */
  OPT_mtune_ = 1098,                         /* -mtune= */
  OPT_muclibc = 1099,                        /* -muclibc */
  OPT_n = 1100,                              /* -n */
  OPT_no_canonical_prefixes = 1101,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1102,              /* -no-integrated-cpp */
  OPT_nocpp = 1103,                          /* -nocpp */
  OPT_nodefaultlibs = 1104,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1105,                   /* -nostartfiles */
  OPT_nostdinc = 1106,                       /* -nostdinc */
  OPT_nostdinc__ = 1107,                     /* -nostdinc++ */
  OPT_nostdlib = 1108,                       /* -nostdlib */
  OPT_o = 1109,                              /* -o */
  OPT_p = 1110,                              /* -p */
  OPT_pass_exit_codes = 1111,                /* -pass-exit-codes */
  /* OPT_pedantic = 1112, */                 /* -pedantic */
  OPT_pedantic_errors = 1113,                /* -pedantic-errors */
  OPT_pg = 1114,                             /* -pg */
  OPT_pie = 1115,                            /* -pie */
  OPT_pipe = 1116,                           /* -pipe */
  OPT_posix = 1117,                          /* -posix */
  OPT_print_file_name_ = 1118,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1119,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1120,          /* -print-multi-directory */
  OPT_print_multi_lib = 1121,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1122,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1123,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1124,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1125,               /* -print-prog-name= */
  OPT_print_search_dirs = 1126,              /* -print-search-dirs */
  OPT_print_sysroot = 1127,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1128,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1129,                        /* -profile */
  OPT_pthread = 1130,                        /* -pthread */
  OPT_quiet = 1131,                          /* -quiet */
  OPT_r = 1132,                              /* -r */
  OPT_rdynamic = 1133,                       /* -rdynamic */
  OPT_remap = 1134,                          /* -remap */
  OPT_s = 1135,                              /* -s */
  OPT_s_bc_abi = 1136,                       /* -s-bc-abi */
  OPT_save_temps = 1137,                     /* -save-temps */
  OPT_save_temps_ = 1138,                    /* -save-temps= */
  OPT_shared = 1139,                         /* -shared */
  OPT_shared_libgcc = 1140,                  /* -shared-libgcc */
  /* OPT_specs = 1141, */                    /* -specs */
  OPT_specs_ = 1142,                         /* -specs= */
  OPT_static = 1143,                         /* -static */
  OPT_static_libasan = 1144,                 /* -static-libasan */
  OPT_static_libgcc = 1145,                  /* -static-libgcc */
  OPT_static_libgcj = 1146,                  /* -static-libgcj */
  OPT_static_libgfortran = 1147,             /* -static-libgfortran */
  OPT_static_libgo = 1148,                   /* -static-libgo */
  OPT_static_liblsan = 1149,                 /* -static-liblsan */
  OPT_static_libstdc__ = 1150,               /* -static-libstdc++ */
  OPT_static_libtsan = 1151,                 /* -static-libtsan */
  OPT_static_libubsan = 1152,                /* -static-libubsan */
  /* OPT_std_c__03 = 1153, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1154, */                /* -std=c++0x */
  OPT_std_c__11 = 1155,                      /* -std=c++11 */
  /* OPT_std_c__14 = 1156, */                /* -std=c++14 */
  OPT_std_c__1y = 1157,                      /* -std=c++1y */
  OPT_std_c__98 = 1158,                      /* -std=c++98 */
  OPT_std_c11 = 1159,                        /* -std=c11 */
  /* OPT_std_c1x = 1160, */                  /* -std=c1x */
  /* OPT_std_c89 = 1161, */                  /* -std=c89 */
  OPT_std_c90 = 1162,                        /* -std=c90 */
  OPT_std_c99 = 1163,                        /* -std=c99 */
  /* OPT_std_c9x = 1164, */                  /* -std=c9x */
  OPT_std_f2003 = 1165,                      /* -std=f2003 */
  OPT_std_f2008 = 1166,                      /* -std=f2008 */
  OPT_std_f2008ts = 1167,                    /* -std=f2008ts */
  OPT_std_f95 = 1168,                        /* -std=f95 */
  OPT_std_gnu = 1169,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1170, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1171, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1172,                    /* -std=gnu++11 */
  /* OPT_std_gnu__14 = 1173, */              /* -std=gnu++14 */
  OPT_std_gnu__1y = 1174,                    /* -std=gnu++1y */
  OPT_std_gnu__98 = 1175,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1176,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1177, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1178, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1179,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1180,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1181, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1182, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1183,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1184, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1185, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1186, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1187,                     /* -std=legacy */
  OPT_symbolic = 1188,                       /* -symbolic */
  OPT_t = 1189,                              /* -t */
  OPT_time = 1190,                           /* -time */
  OPT_time_ = 1191,                          /* -time= */
  OPT_traditional = 1192,                    /* -traditional */
  OPT_traditional_cpp = 1193,                /* -traditional-cpp */
  OPT_trigraphs = 1194,                      /* -trigraphs */
  OPT_u = 1195,                              /* -u */
  OPT_undef = 1196,                          /* -undef */
  OPT_v = 1197,                              /* -v */
  OPT_version = 1198,                        /* -version */
  OPT_w = 1199,                              /* -w */
  OPT_wrapper = 1200,                        /* -wrapper */
  OPT_x = 1201,                              /* -x */
  OPT_z = 1202,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
