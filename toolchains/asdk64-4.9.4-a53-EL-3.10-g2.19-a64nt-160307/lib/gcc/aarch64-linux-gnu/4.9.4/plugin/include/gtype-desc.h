...
#define ggc_alloc_aarch64_frame() ((struct aarch64_frame *)(ggc_internal_alloc_stat (sizeof (struct aarch64_frame) MEM_STAT_INFO)))
#define ggc_alloc_cleared_aarch64_frame() ((struct aarch64_frame *)(ggc_internal_cleared_alloc_stat (sizeof (struct aarch64_frame) MEM_STAT_INFO)))
#define ggc_alloc_vec_aarch64_frame(n) ((struct aarch64_frame *)(ggc_internal_vec_alloc_stat (sizeof (struct aarch64_frame), n MEM_STAT_INFO)))
#define ggc_alloc_cleared_vec_aarch64_frame(n) ((struct aarch64_frame *)(ggc_internal_cleared_vec_alloc_stat (sizeof (struct aarch64_frame), n MEM_STAT_INFO)))
