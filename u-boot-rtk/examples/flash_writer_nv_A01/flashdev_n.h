...
#define NF_CERT_AREA_BLOCK                 (NF_DTE_BOOTCODE_BLOCK+DTE_BOOTCODE_BLOCK_CNT)//ATF_cert + PCPU_cert + AFW_cert + DTE_FW_cert
#define NF_RTK_PARAMS_AREA_BLOCK           (NF_CERT_AREA_BLOCK+CERTIFICATE_AREA_BLOCK_CNT)
#define NF_BL31_BLOCK                      (NF_RTK_PARAMS_AREA_BLOCK+RTK_PARAMS_BLOCK_CNT)
#define NF_TEEOS_BLOCK                     (NF_BL31_BLOCK+BL31_BLOCK_CNT)
...
#define DTE_BOOTCODE_BLOCK_CNT             (DTE_BOOTCODE_MAX_SIZE / g_BlockSize) // 1 or 2 blocks (depend on block size)
