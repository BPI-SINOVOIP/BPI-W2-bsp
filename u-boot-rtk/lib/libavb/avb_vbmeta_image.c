...
AvbVBMetaVerifyResult avb_vbmeta_image_verify(
  ...
  // skip vefication if AVB_VBMETA_IMAGE_FLAGS_VERIFICATION_DISABLED was set
  if (h.flags & AVB_VBMETA_IMAGE_FLAGS_VERIFICATION_DISABLED) {
    printf("AVB_VBMETA_IMAGE_FLAGS_VERIFICATION_DISABLED was set \n");
