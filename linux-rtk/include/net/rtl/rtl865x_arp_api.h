...
int32 rtl865x_getArpMapping(ipaddr_t ip,
	rtl865x_arpMapping_entry_t *arp_mapping);
#if defined(CONFIG_RTL_MULTIPLE_WAN) || defined(CONFIG_RTL_REDIRECT_ACL_SUPPORT_FOR_ISP_MULTI_WAN)
int32 rtl_set_callback_for_ps_arp(int (*call_back_fn) (u32 ip,
		rtl865x_arpMapping_entry_t *entry));
#endif
