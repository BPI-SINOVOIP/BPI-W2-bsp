...
#define HAVE_aarch64_movdi_tflow (reload_completed || reload_in_progress)
#define HAVE_aarch64_movdi_tihigh (reload_completed || reload_in_progress)
#define HAVE_aarch64_movdi_tfhigh (reload_completed || reload_in_progress)
#define HAVE_aarch64_movtihigh_di (reload_completed || reload_in_progress)
#define HAVE_aarch64_movtfhigh_di (reload_completed || reload_in_progress)
#define HAVE_aarch64_movtilow_di (reload_completed || reload_in_progress)
#define HAVE_aarch64_movtflow_di (reload_completed || reload_in_progress)
...
#define HAVE_aarch64_be_checked_get_lanev8qi (TARGET_SIMD)
#define HAVE_aarch64_be_checked_get_lanev16qi (TARGET_SIMD)
#define HAVE_aarch64_be_checked_get_lanev4hi (TARGET_SIMD)
#define HAVE_aarch64_be_checked_get_lanev8hi (TARGET_SIMD)
#define HAVE_aarch64_be_checked_get_lanev2si (TARGET_SIMD)
#define HAVE_aarch64_be_checked_get_lanev4si (TARGET_SIMD)
#define HAVE_aarch64_be_checked_get_lanev2di (TARGET_SIMD)
#define HAVE_aarch64_be_checked_get_lanev2sf (TARGET_SIMD)
#define HAVE_aarch64_be_checked_get_lanev4sf (TARGET_SIMD)
#define HAVE_aarch64_be_checked_get_lanev2df (TARGET_SIMD)
