...
unsigned char drvif_EDIDLoad(unsigned char *EDID, int len)
{
	...
	hdmi_rx_reg_mask32(DDC1_EDID_CR, ~DDC1_EDID_CR_edid_en_mask, DDC1_EDID_CR_edid_en(0), HDMI_RX_DDC);


	for (i = 0; i < len; i++)  {
		/* total 0 ~ 127 */
		hdmi_rx_reg_write32(DDC1_DDC_SIR, i, HDMI_RX_DDC);
		hdmi_rx_reg_write32(DDC1_DDC_SAP, EDID[i], HDMI_RX_DDC);
	}

	/* Set to No Debounce */
	hdmi_rx_reg_write32(DDC1_I2C_CR, 0x00, HDMI_RX_DDC);

	/* Enable DDC func */
	hdmi_rx_reg_mask32(DDC1_EDID_CR, ~DDC1_EDID_CR_edid_en_mask, DDC1_EDID_CR_edid_en(1), HDMI_RX_DDC);
...
{
	hdmi_rx_reg_mask32(DDC1_EDID_CR, ~(DDC1_EDID_CR_DDC1_force_mask | DDC1_EDID_CR_ddc2b_force_mask),
