/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/home/tcwg-buildslave/workspace/tcwg-make-release/builder_arch/amd64/label/tcwg-x86_64-build/target/aarch64-linux-gnu/snapshots/gcc.git~linaro-7.3-2018.05/gcc/config/aarch64/aarch64.md'.  */
...
{
  if (c >= CONSTRAINT_Upl && c <= CONSTRAINT_Ds)
    return;
