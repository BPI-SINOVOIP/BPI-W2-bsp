...
#define UCLIBC_DYNAMIC_LINKER "/lib/ld-uClibc.so.1"
#define UCLIBC_DYNAMIC_LINKER32 "/lib/ld-uClibc.so.1"
#define UCLIBC_DYNAMIC_LINKER64 "/lib/ld64-uClibc.so.1"
#define UCLIBC_DYNAMIC_LINKERX32 "/lib/ldx32-uClibc.so.1"
