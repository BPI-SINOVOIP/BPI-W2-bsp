...
int32 rtl865x_check_authfdbentry_Byport(int32 port_num,
...
int32 rtl_check_fdb_entry_check_exist(uint32 fid, ether_addr_t *mac,
	uint32 flags);
int32 rtl_check_fdb_entry_check_srcBlock(uint32 fid, ether_addr_t *mac,
	int32 *SrcBlk);
