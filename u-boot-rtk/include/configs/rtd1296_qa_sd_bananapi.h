...
#ifndef __CONFIG_RTK_RTD1296_QA_SD_BANANAPI_H
#define __CONFIG_RTK_RTD1296_QA_SD_BANANAPI_H
...
#define CONFIG_SYS_RTK_SD_FLASH
	...
	*   uboot/examples/flash_writer_u/$(CONFIG_FLASH_WRITER_SETTING).inc*/
	#define CONFIG_FLASH_WRITER_SETTING				"1296_force_sd_nS_nE_bananapi"
