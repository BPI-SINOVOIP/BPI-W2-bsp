 ...
 */
#ifndef RTK_PCIE_139x_H_
#define RTK_PCIE_139x_H_
...
#define PCI_DBG(fmt, args...) \
	pr_info("[RTD139x PCIE] DBG, " fmt, ## args)
#else
#define PCI_DBG(fmt, args...) \
do { \
} while (0)
...
#define PCI_INFO(fmt, args...) \
	pr_info("[RTD139x PCIE] INFO," fmt, ## args)
#define PCI_WARNING(fmt, args...) \
	pr_info("[RTD139x PCIE] WARNING," fmt, ## args)

#ifdef PCI_REG_DBG_EN
#define PCI_REG_DBG(fmt, args...) \
	pr_info("[RTD139x PCIE] REG DBG," fmt, ## args)
#else
#define PCI_REG_DBG(fmt, args...) \
do { \
} while (0)
...
#define PCI_CFG_DBG(fmt, args...) \
	pr_info("[RTD139x PCIE] CFG DBG," fmt, ## args)
#else
#define PCI_CFG_DBG(fmt, args...) do {} while (0)
#endif

#define PCI_CFG_WARNING(fmt, args...) pr_alert("[RTD139x PCIE] CFG WARNING," fmt, ## args)
