...
#define MCP_CTRL1 (CP_REG_BASE + 0x198)
...
#define SET_MCP_CTRL1(x,y) writel((x), (volatile unsigned int*) (MCP_CTRL1+y))
...
#define GET_MCP_CTRL1(y) readl((volatile unsigned int*) (MCP_CTRL1+y))
...
#define mcp_dump_data_with_text(data, len ,fmt, args...)  do {\
								pr_err(fmt, ## args);\
								crypto_mcp_dump_mem(data, len);\
								}while(0)

/* Debug */
//#define MCP_DEBUG_EN
#ifdef MCP_DEBUG_EN
#define mcp_debug(fmt, args...) pr_err("[MCP] Debug, " fmt, ## args)
#else
#define mcp_debug(fmt, args...)
#endif

#ifdef MCP_DEBUG_EN
#define mcp_info(fmt, args...) pr_err("[MCP] " fmt, ## args)
...
#define CRYPTO_SHA256_H0		0x6A09E667
#define CRYPTO_SHA256_H1		0xBB67AE85
#define CRYPTO_SHA256_H2		0x3C6EF372
#define CRYPTO_SHA256_H3		0xA54FF53A
#define CRYPTO_SHA256_H4		0x510E527F
#define CRYPTO_SHA256_H5		0x9B05688C
#define CRYPTO_SHA256_H6		0x1F83D9AB
#define CRYPTO_SHA256_H7		0x5BE0CD19

/*kernel crypto relate*/
